  ...
  return (
    <div className="bg-[#161b26] border border-gray-800/50 p-6 rounded-[28px] shadow-lg flex flex-col h-full">
      <div className="mb-4">
        ...
        <p className="text-xs text-gray-500 font-medium">Classificação e fidelização</p>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-between min-h-[200px]">
        ...
        <div className="relative w-full h-32 flex items-end justify-center overflow-hidden">
          {mounted ? (
            ...
            <div className="w-24 h-12 rounded-t-full border-4 border-gray-800 animate-pulse"></div>
          )}
        ...
        {/* Legend / Metrics Grid */}
        <div className="w-full grid grid-cols-2 gap-x-6 gap-y-3.5 mt-4 border-t border-gray-800/40 pt-4">
          {/* Novo(a) */}
          <div className="flex items-center justify-between text-xs">
            <div className="flex items-center gap-1.5 min-w-0">
              <span className="w-2.5 h-2.5 rounded bg-[#06B6D4] shrink-0" />
              <span className="font-bold text-gray-400 truncate">Novo(a)</span>
            </div>
            <span className="font-black text-white ml-2">{data.novo}</span>
          </div>
          ...
          <div className="flex items-center justify-between text-xs">
            <div className="flex items-center gap-1.5 min-w-0">
              ...
              <span className="font-bold text-gray-400 truncate">Inativo</span>
            </div>
            <span className="font-black text-white ml-2">{data.inativo}</span>
          </div>
          ...
          <div className="flex items-center justify-between text-xs">
            <div className="flex items-center gap-1.5 min-w-0">
              ...
              <span className="font-bold text-gray-400 truncate">Regulares</span>
            </div>
            <span className="font-black text-white ml-2">{data.regular}</span>
          </div>
          ...
          <div className="flex items-center justify-between text-xs">
            <div className="flex items-center gap-1.5 min-w-0">
              ...
              <span className="font-bold text-gray-400 truncate">Lista negra</span>
            </div>
            <span className="font-black text-white ml-2">{data.listaNegra}</span>
          </div>
          ...
          <div className="col-span-2 flex items-center justify-between bg-purple-500/10 border border-purple-500/25 px-4 py-2 rounded-2xl text-xs mt-1">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-purple-300">Taxa de Retenção</span>
            </div>
